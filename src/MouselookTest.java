...
/**
    ...
    the screen.
    <p>Mouselook works by re-centering the mouse whenever it is
    ...
    implements MouseMotionListener, KeyListener
{
    ...
    public void init() {
        ...
        // initialize Cursor object by calling createCustomCursor() and pass it
        // an empty string for a filename to have no image, still must be set
        invisibleCursor = 
        		Toolkit.getDefaultToolkit().createCustomCursor(
        		Toolkit.getDefaultToolkit().getImage(""),
        		centerLocation, "invisible");
    }
    ...
    */
    private synchronized void recenterMouse() {
        Window window = screen.getFullScreenWindow();
        // set the custom cursor as the cursor for this JFrame window
